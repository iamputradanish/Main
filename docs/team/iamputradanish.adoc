...
* *Minor enhancement*: added a logout command that allows any user to log out of the System immediately at any time.
...
*** Updated the GUI color scheme and background image (Pull requests https://github.com/CS2113-AY1819S1-F10-3/main/pull/98[#98])
